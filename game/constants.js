...
// tooling       → qualidade de ferramentas/IDE/autocomplete, docs e bibliotecas
// verbosidade   → quanto código/cerimônia/boilerplate é necessário (maior = mais verboso)
// mobile        → quão forte é a linguagem para apps mobile (nativo/Flutter/MAUI/React Native, etc.)
//
...
export const LANGUAGES = [
  ...
  },
  {
    ...
    stats: { performance: 95, facilidade: 30, mercado: 72, complexidade: 92, popularidade: 65, tooling: 60, verbosidade: 83, mobile: 68 }
  },
  {
    name: "C#",
  ...
  },
  {
    ...
    stats: { performance: 72, facilidade: 82, mercado: 80, complexidade: 55, popularidade: 75, tooling: 78, verbosidade: 40, mobile: 77 }
  },
  {
    name: "C",
  ...
  },
  {
    ...
    stats: { performance: 80, facilidade: 76, mercado: 75, complexidade: 62, popularidade: 74, tooling: 96, verbosidade: 47, mobile: 97 }
  },
  {
    name: "Swift",
    ...
    stats: { performance: 85, facilidade: 72, mercado: 72, complexidade: 62, popularidade: 73, tooling: 94, verbosidade: 48, mobile: 98 }
  },
  {
    name: "Ruby",
    ...
    stats: { performance: 58, facilidade: 88, mercado: 70, complexidade: 50, popularidade: 68, tooling: 73, verbosidade: 35, mobile: 70 }
  },
  {
    name: "Scala",
    ...
    stats: { performance: 85, facilidade: 45, mercado: 60, complexidade: 88, popularidade: 55, tooling: 54, verbosidade: 75, mobile: 59 }
  },
  {
    name: "Dart",
    ...
    stats: { performance: 78, facilidade: 80, mercado: 65, complexidade: 55, popularidade: 70, tooling: 71, verbosidade: 41, mobile: 90 }
  },
  {
    name: "Lua",
    ...
    stats: { performance: 82, facilidade: 72, mercado: 48, complexidade: 45, popularidade: 58, tooling: 58, verbosidade: 38, mobile: 58 }
  },
  {
    name: "COBOL",
    ...
    stats: { performance: 70, facilidade: 30, mercado: 72, complexidade: 80, popularidade: 40, tooling: 46, verbosidade: 76, mobile: 54 }
  },
  {
    name: "Elixir",
    ...
    stats: { performance: 85, facilidade: 60, mercado: 58, complexidade: 72, popularidade: 55, tooling: 57, verbosidade: 59, mobile: 60 }
  },
  {
    name: "Haskell",
    ...
    stats: { performance: 80, facilidade: 30, mercado: 50, complexidade: 95, popularidade: 45, tooling: 43, verbosidade: 85, mobile: 49 }
  },
  {
    name: "Perl",
    ...
    stats: { performance: 72, facilidade: 35, mercado: 38, complexidade: 85, popularidade: 32, tooling: 34, verbosidade: 77, mobile: 38 }
  },
  {
    name: "R",
    ...
    stats: { performance: 55, facilidade: 55, mercado: 68, complexidade: 65, popularidade: 62, tooling: 62, verbosidade: 57, mobile: 63 }
  },
  {
    name: "Groovy",
    ...
    stats: { performance: 68, facilidade: 75, mercado: 48, complexidade: 55, popularidade: 45, tooling: 52, verbosidade: 43, mobile: 51 }
  },
  {
    name: "Objective-C",
    ...
    stats: { performance: 82, facilidade: 38, mercado: 38, complexidade: 80, popularidade: 35, tooling: 36, verbosidade: 73, mobile: 80 }
  },
  {
    name: "OCaml",
    ...
    stats: { performance: 87, facilidade: 38, mercado: 42, complexidade: 88, popularidade: 36, tooling: 38, verbosidade: 78, mobile: 44 }
  },
  {
    name: "Zig",
    ...
    stats: { performance: 96, facilidade: 42, mercado: 32, complexidade: 82, popularidade: 42, tooling: 40, verbosidade: 72, mobile: 44 }
  },
  {
    name: "Nim",
    personality: "Rápido, elegante e incompreendido 🌙",
    // Sem mudanças — Nim já estava calibrado de forma realista.
    stats: { performance: 90, facilidade: 60, mercado: 28, complexidade: 65, popularidade: 32, tooling: 37, verbosidade: 55, mobile: 39 }
  },
  {
    name: "Clojure",
    ...
    stats: { performance: 75, facilidade: 32, mercado: 48, complexidade: 90, popularidade: 40, tooling: 40, verbosidade: 81, mobile: 46 }
  },
  {
    name: "Erlang",
    ...
    stats: { performance: 78, facilidade: 32, mercado: 45, complexidade: 88, popularidade: 37, tooling: 38, verbosidade: 80, mobile: 44 }
  },
  {
    name: "Julia",
    ...
    stats: { performance: 91, facilidade: 65, mercado: 52, complexidade: 62, popularidade: 50, tooling: 54, verbosidade: 51, mobile: 56 }
  },
  {
    name: "Solidity",
    ...
    stats: { performance: 45, facilidade: 48, mercado: 62, complexidade: 78, popularidade: 58, tooling: 57, verbosidade: 68, mobile: 57 }
  },
  {
    name: "Bash",
    ...
    stats: { performance: 60, facilidade: 45, mercado: 72, complexidade: 75, popularidade: 75, tooling: 68, verbosidade: 67, mobile: 70 }
  },
  {
    name: "Crystal",
    ...
    stats: { performance: 88, facilidade: 72, mercado: 30, complexidade: 60, popularidade: 35, tooling: 41, verbosidade: 47, mobile: 42 }
  },
  {
    name: "Fortran",
    ...
    stats: { performance: 94, facilidade: 28, mercado: 35, complexidade: 78, popularidade: 30, tooling: 31, verbosidade: 76, mobile: 38 }
  },
  {
    name: "Visual Basic",
    personality: "Forms, macros e nostalgia — funciona até hoje 📎",
    // VB/VB.NET: ótimo para automação e sistemas legados, mas não é a escolha moderna para tudo.
    stats: { performance: 45, facilidade: 75, mercado: 40, complexidade: 45, popularidade: 35, tooling: 90, verbosidade: 37, mobile: 62 }
  },
  {
    name: "Assembly",
  ...
  {
    name: "Portugol",
    personality: "Aprendizado em PT-BR, sem medo de errar 📘",
    // Excelente para começar a aprender lógica, mas não é usado na indústria.
    stats: { performance: 10, facilidade: 95, mercado: 5, complexidade: 10, popularidade: 25, tooling: 34, verbosidade: 8, mobile: 23 }
  },
  {
    name: "SQL",
  ...
  {
    name: "MATLAB",
    personality: "Matriz aqui, gráfico ali 📊",
    // Forte em engenharia/academia, menos comum em produto/indústria geral.
    stats: { performance: 60, facilidade: 60, mercado: 35, complexidade: 60, popularidade: 40, tooling: 43, verbosidade: 52, mobile: 42 }
  },
  {
    name: "Scratch",
  ...
  {
    name: "Delphi",
    personality: "RAD de respeito, mas meio escondido 🕵️",
    // Ainda existe em sistemas legados (inclusive no Brasil), porém com comunidade pequena.
    stats: { performance: 75, facilidade: 55, mercado: 25, complexidade: 65, popularidade: 20, tooling: 28, verbosidade: 57, mobile: 30 }
  },
  {
    name: "Ada",
    personality: "Segurança e rigor em primeiro lugar 🛡️",
    // Forte em domínios críticos (aeroespacial/defesa), mas mercado geral é baixo.
    stats: { performance: 85, facilidade: 25, mercado: 15, complexidade: 80, popularidade: 10, tooling: 14, verbosidade: 78, mobile: 21 }
  },
]
...
export const QUESTIONS = [
  ...
  // Nichos (domínios específicos)
  "Qual linguagem é melhor para microcontroladores?",
  "Qual linguagem é melhor para programação de baixo nível (drivers/kernels)?",
  "Qual linguagem é melhor para bancos de dados e consultas?",
  "Qual linguagem é melhor para análise de dados?",
  "Qual linguagem é melhor para machine learning?",
  "Qual linguagem é melhor para computação científica/engenharia?",
  "Qual linguagem é melhor para automação de planilhas/Office?",
  "Qual linguagem é melhor para scripting em games?",
  "Qual linguagem é melhor para DevOps e scripts de infraestrutura?",
  "Qual linguagem é melhor para apps iOS?",
  "Qual linguagem é melhor para apps Android?",
  "Qual linguagem é melhor para desktop Windows?",
  "Qual linguagem é melhor para sistemas legado corporativo?",
  "Qual linguagem é melhor para ensinar programação para crianças?",

  // Países (tendências gerais; heurístico/humor — não é dado científico)
  "Qual linguagem é mais comum no Brasil?",
  "Qual linguagem é mais comum nos EUA?",
  "Qual linguagem é mais comum no Japão?",
  "Qual linguagem é mais comum na Índia?",
...
export const QUESTION_WEIGHTS = {
  ...
  "Qual linguagem tem a melhor sintaxe?": { facilidade: 0.7, verbosidade: -0.2, complexidade: -0.1 },
  ...
  "Qual linguagem tem menos código boilerplate?": { facilidade: 0.6, verbosidade: -0.4 },

  // Agradável de manter: facilidade de leitura + ecossistema maduro
  "Qual linguagem é mais agradável de manter?": { facilidade: 0.35, verbosidade: -0.25, tooling: 0.25, popularidade: 0.15 },

  // Debugar: tooling maduro (popularidade) + sintaxe clara (facilidade)
  "Qual linguagem é mais fácil de debugar?": { facilidade: 0.35, tooling: 0.35, popularidade: 0.2, complexidade: -0.1 },

  // Melhores ferramentas: ecossistema rico + mercado que justifica investimento em tooling
  "Qual linguagem tem as melhores ferramentas?": { tooling: 0.7, mercado: 0.2, popularidade: 0.1 },
  ...
  "Qual linguagem tem o melhor autocomplete?": { tooling: 0.75, complexidade: 0.15, popularidade: 0.1 },
  ...
  "Qual linguagem tem melhor documentação?": { tooling: 0.6, popularidade: 0.25, mercado: 0.15 },
  ...
  "Qual linguagem tem mais material de estudo?": { popularidade: 0.6, tooling: 0.4 },
  ...
  "Qual linguagem tem melhor comunidade?": { popularidade: 0.7, tooling: 0.3 },

  // Bibliotecas: Python (pip), JS (npm) dominam em volume puro
  "Qual linguagem tem mais bibliotecas disponíveis?": { tooling: 0.55, popularidade: 0.35, mercado: 0.1 },

  "Qual linguagem tem o melhor ecossistema?": { tooling: 0.5, popularidade: 0.3, mercado: 0.2 },

  // Melhores frameworks: qualidade + adoção = popularidade + performance do resultado
  "Qual linguagem tem os melhores frameworks?": { tooling: 0.5, popularidade: 0.3, mercado: 0.2 },

  // Evolui mais rápido: linguagens com comunidade ativa e empresa por trás
  "Qual linguagem evolui mais rápido?": { popularidade: 0.45, mercado: 0.25, tooling: 0.2, complexidade: 0.1 },

  "Qual linguagem tem as melhores ferramentas open source?": { popularidade: 0.55, tooling: 0.45 },

  "Qual linguagem tem mais suporte da comunidade?": { popularidade: 0.6, tooling: 0.4 },

  // Libs confiáveis: ecossistema maduro = popularidade + mercado consolidado
  "Qual linguagem tem as libs mais confiáveis?": { tooling: 0.5, performance: 0.2, mercado: 0.2, popularidade: 0.1 },
  ...
  "Qual linguagem tem mais dependências inúteis?": { popularidade: 0.4, tooling: 0.3, facilidade: 0.2, complexidade: 0.1 },
  ...
  "Qual linguagem tem mais problemas de versão?": { tooling: 0.4, complexidade: 0.4, popularidade: 0.2 },
  ...
  "Qual linguagem tem o ecossistema mais bagunçado?": { complexidade: 0.4, tooling: 0.3, popularidade: 0.2, verbosidade: 0.1 },
  ...
  // Microcontroladores: baixo nível e performance (C/Assembly/Rust tendem a vencer)
  "Qual linguagem é melhor para microcontroladores?": { performance: 0.6, complexidade: 0.3, mercado: 0.1 },

  // Drivers/kernels: performance + complexidade (controle fino e edge cases)
  "Qual linguagem é melhor para programação de baixo nível (drivers/kernels)?": { performance: 0.5, complexidade: 0.4, mercado: 0.1 },

  // Banco de dados: tooling e ubiquidade (SQL deve vencer com folga)
  "Qual linguagem é melhor para bancos de dados e consultas?": { tooling: 0.9, mercado: 0.1 },

  // Dados: ecossistema e DX para análise (Python/R)
  "Qual linguagem é melhor para análise de dados?": { tooling: 0.35, popularidade: 0.25, facilidade: 0.2, mercado: 0.2 },

  // ML: libs e tooling (Python domina culturalmente)
  "Qual linguagem é melhor para machine learning?": { tooling: 0.4, popularidade: 0.25, mercado: 0.2, performance: 0.15 },

  // Científica/engenharia: performance + tooling (MATLAB/Julia/Python)
  "Qual linguagem é melhor para computação científica/engenharia?": { performance: 0.35, tooling: 0.35, popularidade: 0.15, complexidade: 0.15 },

  // Office: DX e tooling (VB/Python tendem a aparecer)
  "Qual linguagem é melhor para automação de planilhas/Office?": { tooling: 0.7, facilidade: 0.2, mercado: 0.1 },

  // Games: scripting simples e popular (Lua)
  "Qual linguagem é melhor para scripting em games?": { facilidade: 0.4, popularidade: 0.25, tooling: 0.2, performance: 0.15 },

  // DevOps: mercado + tooling (Bash/Python)
  "Qual linguagem é melhor para DevOps e scripts de infraestrutura?": { mercado: 0.4, tooling: 0.3, performance: 0.15, facilidade: 0.15 },

  // Mobile iOS/Android e desktop
  "Qual linguagem é melhor para apps iOS?": { mobile: 0.75, tooling: 0.15, performance: 0.1 },
  "Qual linguagem é melhor para apps Android?": { mobile: 0.6, tooling: 0.15, mercado: 0.2, performance: 0.05 },
  "Qual linguagem é melhor para desktop Windows?": { tooling: 0.6, mercado: 0.3, performance: 0.1 },

  // Legado corporativo: mercado consolidado + complexidade (sistemas grandes e difíceis de migrar)
  "Qual linguagem é melhor para sistemas legado corporativo?": { mercado: 0.5, complexidade: 0.25, verbosidade: 0.15, tooling: 0.1 },

  // Crianças: facilidade extrema + tooling educacional
  "Qual linguagem é melhor para ensinar programação para crianças?": { facilidade: 0.6, mercado: -0.25, tooling: 0.15 },

  // ---------------------------------------------------------------------------
  // PAÍSES (tendências gerais; heurístico/humor — não é dado científico)
  // ---------------------------------------------------------------------------

  "Qual linguagem é mais comum no Brasil?": { mercado: 0.45, popularidade: 0.3, facilidade: 0.15, tooling: 0.1 },
  "Qual linguagem é mais comum nos EUA?": { mercado: 0.5, performance: 0.2, tooling: 0.2, popularidade: 0.1 },
  "Qual linguagem é mais comum no Japão?": { mercado: 0.45, performance: 0.25, tooling: 0.15, complexidade: 0.15 },
  "Qual linguagem é mais comum na Índia?": { mercado: 0.5, popularidade: 0.2, facilidade: 0.2, tooling: 0.1 },
  ...
  "Qual linguagem tem a pior sintaxe?": { facilidade: -0.5, verbosidade: 0.3, complexidade: 0.2 },
  ...
  "Qual linguagem tem mais código feio na internet?": { popularidade: 0.4, verbosidade: 0.3, facilidade: 0.2, performance: -0.1 },
  ...
  "Qual linguagem gera mais bugs em produção?": { facilidade: 0.35, popularidade: 0.25, tooling: -0.2, verbosidade: 0.2 },
  ...
  "Qual linguagem vira mais 'spaghetti code'?": { verbosidade: 0.5, complexidade: 0.3, popularidade: 0.2 },
